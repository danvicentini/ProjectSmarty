...
class empresaModel extends model
{
    ...
    {
        return $this->insert('cad_empresa', $data, true);
    }

    public function upd($data, $srvId)
    {
        return $this->update('cad_empresa', $data, 'cod_empresa=' . $srvId, true);
    }
    ...
    public function getEmpresa($emp_id = null, $filtro = null)
    {
        $arrWhere = array();
				if(!is_null($emp_id))
            $arrWhere[] = "emp.cod_empresa = $emp_id";
    ...
    public function del($emp_id)
    {
        $where = "cod_empresa = $emp_id";
        return $this->delete('cad_empresa', $where, true);
    }

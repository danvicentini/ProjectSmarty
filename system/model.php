...
class model {
  ...
  public function __construct() {
    try {
      ...
      $this->database = $_SESSION['projeto']['db_name'];
      $this->user = $_SESSION['projeto']['db_user'];
      $this->password = $_SESSION['projeto']['db_password'];

      $this->db = new PDO('mysql:host=' . $this->host . ';dbname=' . $this->database . ';port=' . $this->port, $this->user, $this->password, array(PDO::MYSQL_ATTR_INIT_COMMAND => 'SET NAMES ' . DBENCODING));
  ...
  public function insert($table = NULL, array $data = NULL, $exec = TRUE, $debug = null) {
  ...
  public function read($table = NULL, $fields = NULL, $where = NULL, $group_by = NULL, $limit = NULL, $offset = NULL, $orderby = NULL, $freeQuerie = NULL, $showQuery = false) {
    $this->_table = ($table != NULL ? $table : NULL);
    if ($this->_table == NULL)
      return FALSE;
	...
	public function executeProcedure($proc, $showQuery = false) {
  ...
  public function update($table = NULL, array $data = NULL, $where, $exec = TRUE, $debug=null) {
    $this->_table = ($table != NULL ? $table : NULL);
    if ($this->_table == NULL)
      return FALSE;
  ...
  public function delete($table = NULL, $where = NULL, $exec = TRUE, $debug = null) {
    $this->_table = ($table != NULL ? $table : NULL);
    if ($this->_table == NULL)
      return FALSE;
